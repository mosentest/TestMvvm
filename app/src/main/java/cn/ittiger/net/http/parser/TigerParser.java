...
public abstract class TigerParser<T> {
     ...
     * @return 解析成功返回{@link List}， 返回的实体对象Class对象
    ...
    /**
     * TODO 分析这里代码，我们可以看到TigerOkhttp 对返回结果按他自己思路写的，如果自己公司业务不是这样，就重新定义这里，要么设置isWrapperResult =false
     * 获取请求返回的结果
     *
